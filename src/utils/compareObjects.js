...
//       let curVal1 = isDate(`${object1Vals[i]}`) ? new Date(`${object1Vals[i]}`).getTime() : object1Vals[i];
//       let curVal2 = isDate(`${object2Vals[j]}`) ? new Date(`${object2Vals[j]}`).getTime() : object2Vals[j];
